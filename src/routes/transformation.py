...
@router.post("/", status_code=status.HTTP_201_CREATED, response_model=PhotoTransformResponse,
...
async def apply_transformation(
    ...
    return await repositories_transformations.create_crop_transformation(original_photo, body, db)
